...
(display "É um número INTEIRO 3/7 ?:  ")(integer? 3/7)
;; 

(newline)
(display "É um número REAL 2 ?:  ")(real? 2)
(display "É um número REAL 3/5 ?:  ")(real? 3/5)
(display "É um número REAL 4+5i ?:  ")(real? 4+5i)

;;
(newline)
(display "É um número COMPLEXO 5+3i ?:  ")(complex? 5+3i)
;;

(newline)
(display "É um STRING 'Oi...' ?:  ")(string? "Oi...")
(display "É um STRING 24 ?:  ")(string? 24)
